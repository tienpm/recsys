# -*- encoding: utf-8 -*-
r"""
reczoo.data.dataloader.abstract_dataloader
################################################
"""
...
from reczoo.utils import InputType, FeatureType, FeatureSource, ModelType
...
class AbstractDataLoader(torch.utils.data.DataLoader):
    ...
    :class:`~reczoo.data.interaction.Interaction` when it is iterated.
