# -*- encoding: utf-8 -*-
"""
reczoo.data.dataloader.knowledge_dataloader
################################################
"""
from logging import getLogger
from reczoo.data.dataloader.abstract_dataloader import AbstractDataLoader
from reczoo.data.dataloader.general_dataloader import TrainDataLoader
from reczoo.data.interaction import Interaction
from reczoo.utils import InputType, KGDataLoaderState
import numpy as np
...
class KnowledgeBasedDataLoader:
    ...
    In different states, :meth:`~_next_batch_data` will return different :class:`~reczoo.data.interaction.Interaction`.
    ...
    Attributes:
        state (KGDataLoaderState):
            This dataloader has three states:
                - :obj:`~reczoo.utils.enum_type.KGDataLoaderState.RS`
                - :obj:`~reczoo.utils.enum_type.KGDataLoaderState.KG`
                - :obj:`~reczoo.utils.enum_type.KGDataLoaderState.RSKG`
