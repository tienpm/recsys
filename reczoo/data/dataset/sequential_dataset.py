# -*- coding: utf-8 -*-
r"""
reczoo.data.sequential_dataset
###############################
"""
...
from reczoo.data.dataset import Dataset
from reczoo.data.interaction import Interaction
from reczoo.utils.enum_type import FeatureType, FeatureSource


class SequentialDataset(Dataset):
    """:class:`SequentialDataset` is based on :class:`~reczoo.data.dataset.dataset.Dataset`,
    ...
    def build(self):
        ...
        Args:
            eval_setting (:class:`~reczoo.config.eval_setting.EvalSetting`):
