# -*- coding: utf-8 -*-
r"""
reczoo.data.customized_dataset
##################################
...
from reczoo.data.dataset import KGSeqDataset, SequentialDataset
from reczoo.data.interaction import Interaction
from reczoo.sampler import SeqSampler
from reczoo.utils.enum_type import FeatureType
...
class DIENDataset(SequentialDataset):
    """:class:`DIENDataset` is based on :class:`~reczoo.data.dataset.sequential_dataset.SequentialDataset`.
    ...
    Attributes:
        ...
        seq_sample (reczoo.sampler.SeqSampler): A sampler used to sample negative item sequence.
