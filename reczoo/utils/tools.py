...
from reczoo.utils.enum_type import ModelType
...
def get_flops(model, dataset, device, logger, transform, verbose=False):
    ...
    """
    # TODO: implement the FLOPS calculator
    pass
...
def get_environment(config):
    r"""
        Get environment usage of the running server
    Args:
        config: the config options that assign what gpu which be used
