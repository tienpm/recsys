...
r"""
reczoo.metrics.abstract_metric
#####################################
"""

import torch
from reczoo.utils import EvaluatorType
from abc import ABC, abstractmethod


class AbstractMetric(ABC):
    r""":class:`AbstractMetric` is the base object of all metrics. If you want to
    ...
    def calculate_metric(self, dataobject):
        r"""Get the dictionary of a metric.
...
class TopkMetric(AbstractMetric):
    r""":class:`TopkMetric` is a base object of top-k metrics. If you want to
    ...
    def used_info(self, dataobject):
        r"""Get the bool matrix indicating whether the corresponding item is positive
    ...
    def topk_result(self, metric, value):
        r"""Match the metric value to the `k` and put them in `dictionary` form.
    ...
    def metric_info(self, pos_index, pos_len=None):
        r"""Calculate the value of the metric.
...
class LossMetric(AbstractMetric):
    r""":class:`LossMetric` is a base object of loss based metrics and AUC. If you want to
    ...
    def used_info(self, dataobject):
        r"""Get scores that model predicted and the ground truth."""
